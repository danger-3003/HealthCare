        ...
        <>
            {
                ...
                <>
                    <Card text={`${(totalSys/data.length).toFixed(0)}/${(totalDys/data.length).toFixed(0)}`} bg="bg-red-300" size="19" color="mt-4 text-slate-700" icon={<FontAwesome5 name="heartbeat" size={24} color="red" />} heading="BP" headColor="text-red-700"/>
